...
Write-Host $BacUA.CreateDecryptor().GetType();
...
Write-Output ($uZOcm.GetType());
[System.IO.File]::WriteAllBytes("$pwd/decrypted.txt", $uZOcm);

$decoded = [System.Text.Encoding]::UTF8.GetString($uZOcm);
Write-Host $decoded;
