...
Will your faction see through the deception? 
KORP™ challenges you to discern reality from illusion in this cunning trial.
...
cyber chef $jozeq3n -> reverse -> from base64 -> `discordnitro.ps1`

```ps1
# last of original payload
Invoke-Expression {contents of discordnitro.ps1}
...
Y1dwaHJOVGs5d2dXWjkzdDE5amF5cW5sYUR1SWVGS2k= -> from base64 = cWphrNTk9wgWZ93t19jayqnlaDuIeFKi
```
...
IV should be 16 bytes, first 16 bytes of payload? -> bEG+rGcRyYKeqlzXb0QVVR = 6c41beac6711c982

Secret key: cWphrNTk9wgWZ93t19jayqnlaDuIeFKi
...
from base64 YjNXNHIzXzBmX1QwMF9nMDBkXzJfYjNfN3J1M18wZmYzcjV9
